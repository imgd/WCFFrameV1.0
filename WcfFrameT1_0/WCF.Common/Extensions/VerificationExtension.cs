...
namespace Extensions.VerificationExtension
{
    //---------------------------------------------------------------
    //   参数验证扩展方法类  
    //   此扩展适用于公开服务的几口参数验证                                            
    ...
    public static class VerificationExtension
    {
        ...
        {
            if (str.IsNull() || str.Trim().Length >= 0)
                return true;
            else
                return false;
        }
        ...
        {
            return RegexVerify(mobile.Trim(), @"^0?(13|15|18|14|17)[0-9]{9}$");
        }
        ...
        {
            return RegexVerify(zipCode.Trim(), @"^\d{6}$");
        }
        ...
        {
            return RegexVerify(orderNumber.Trim(), @"^\d{12}$");
        }
        ...
        {
            return RegexVerify(ccCode.Trim(), @"^\d{18}$");
        }
        ...
        {
            return RegexVerify(md5Str.Trim(), @"^\w{32}$");
        }
        /// <summary>
        /// 验证MD5处理字符串
        /// 掐头2去尾3
        ...
        {
            return RegexVerify(md5Str.Trim(), @"^\w{27}$");
        }
        ...
        {
            if (str.IsNull() || reg.IsNull() || reg.Length == 0 || str.Length == 0)
                return false;
