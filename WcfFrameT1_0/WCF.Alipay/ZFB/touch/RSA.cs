...
namespace Com.Alipay.Touch
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        public static string GetResponseMysign(SortedDictionary<string, string> inputPara,string key,string signtype,string charset)
        {
            Dictionary<string, string> sPara = new Dictionary<string, string>();

            //过滤空值、sign与sign_type参数
            sPara =Com.Alipay.Core.FilterPara(inputPara);

            //获得签名结果
            string mysign = Com.Alipay.Core.BuildMysign(sPara, key, signtype, charset);
