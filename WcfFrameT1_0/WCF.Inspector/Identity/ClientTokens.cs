...
using Extensions.CacheExtension;
...
namespace WCF.Inspector
{
    public class ClientTokens
    {
        ...
        /// 加密公钥
        /// </summary>
        private readonly string EnPublicKey = ConfigHelper.GetAppSettingsString("entoken_publicKey");
        ...
        public string KeyEnCode(string clientkey)
        {
            ...
            return (DateTime.Now.AddSeconds(IdentityExpire).DateTimeConvertTimeStamp() + ","
                    + key + ","
                    + clientkey)
