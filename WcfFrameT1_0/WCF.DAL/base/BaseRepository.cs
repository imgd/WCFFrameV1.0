...
namespace WCF.DAL
{
    ...
    public class BaseRepository<T> where T : class
    {
        ...
        public T AddEntity(T entity)
        {
            ...
            //EF5.0的写法
            curDbContext.Entry<T>(entity).State = EntityState.Added;
            //下面的写法统一
            //db.SaveChanges();
            return entity;
        }
        ...
        public bool UpdateEntity(T entity)
        {
            ...
            curDbContext.Entry<T>(entity).State = EntityState.Detached;
        ...
        public bool DeleteEntity(T entity)
        {
            ...
            //EF5.0的写法
            curDbContext.Set<T>().Attach(entity);
            curDbContext.Entry<T>(entity).State = EntityState.Deleted;
        ...
        {            
            ...
            //EF5.0的写法
            return curDbContext.Set<T>().Where<T>(whereLambda).AsQueryable();
        }
                                                 ...
                                                 bool isAsc, Expression<Func<T, S>> orderByLambda)
        {
            //EF4.0和上面的查询一样
            //EF5.0
            var temp = curDbContext.Set<T>().Where<T>(whereLambda);
